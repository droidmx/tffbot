...
let nest = "somethiasdngidec"
let nestid = "alsosoasdmethingidec"
let nkilled = 'ifuckindoasdntcare'
let nchannel = msg.guild.channels.find("name", "click-here-for-nests")
let sen = "somsdfethisngidec"
...
if (!test[nest]) test[nest] = 87
if (!test[sen]) test[sen] = 94
